//http://localhost:8080/webapp-javaee7-1.1/CalendarServlet
package tommy;
...
public class CalendarServlet extends HttpServlet {
            ...
            HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        //http://localhost:8080/webapp-javaee7-1.1/CalendarServlet?username=diogo
        if(username==null)
            username="Guest";

        Map<String,String> data = getData(username);
    ...
    private Map<String, String> getData(String username) 
    {
